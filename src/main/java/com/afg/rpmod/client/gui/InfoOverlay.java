...
public class InfoOverlay extends Gui {
	...
	public void doRender() {
		...
		if(hit.typeOfHit == RayTraceResult.Type.BLOCK)
			if(Minecraft.getMinecraft().theWorld.getBlockState(hit.getBlockPos()).getBlock() instanceof ApartmentDoor){
				...
				this.drawCenteredString(Minecraft.getMinecraft().fontRendererObj, te.getApartment().getName(), screenwidth/2, screenheight/2 - 15, 0x00FF00);
			}
	}
