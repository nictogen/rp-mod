...
public class CancelableShapelessOreRecipe extends ShapelessOreRecipe {

	public CancelableShapelessOreRecipe(ShapelessOreRecipe recipe) {
		super(recipe.getRecipeOutput(), recipe.getInput());
	}
